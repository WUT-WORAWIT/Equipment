...
$sql = "INSERT INTO tb_dcabinet (data_sequence,data_pic,data_list,data_sequence2,data_id,data_place,data_institution,data_note)
...
header('Refresh: 2; URL=../../admin/data/dataDocument_cabinet.php');
mysqli_close($conn);
