...
$sql = "INSERT INTO tb_circu (data_sequence,data_pic,data_list,data_sequence2,data_id,data_place,data_institution,data_note)
...
header('Refresh: 2; URL=../../admin/data/dataCircu.php');
mysqli_close($conn);
