...
$sql = "INSERT INTO tb_computer (data_sequence,data_pic,data_list,data_sequence2,data_id,data_place,data_institution,data_note)
...
header('Refresh: 2; URL=../../admin/data/dataComputer_desk.php');
mysqli_close($conn);
