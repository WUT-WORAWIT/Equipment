...
$id = $_GET["id"];
$conn = mysqli_connect($server,$username,$password,$dbname);
$sql = "SELECT * FROM tb_steel WHERE data_sequence = '".$id."'";
$query = mysqli_query($conn,$sql);
...
<html lang="en">
  ...
  <body>
    ...
    <main role="main" class="container">
      ...
      ?>
      <form action="edit.steel.process.php" method="post" enctype="multipart/form-data">
        <input type="hidden" name="id" value="<?php echo $obj['data_sequence']?>"/>
	          ...
	          <a href="../../admin/data/dataSteel_cabinet.php" class="btn btn-danger"><i class="fas fa-times"></i> ยกเลิก</a>
