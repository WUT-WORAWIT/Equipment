...
$id = $_GET["id"];
$conn = mysqli_connect($server,$username,$password,$dbname);
$sql = "SELECT * FROM tb_rack WHERE data_sequence = '".$id."'";
$query = mysqli_query($conn,$sql);
...
<html lang="en">
  ...
  <body>
    ...
    <main role="main" class="container">
      ...
      ?>
      <form action="edit.rack.process.php" method="post" enctype="multipart/form-data">
	          ...
	          <a href="../../admin/data/dataRack.php" class="btn btn-danger"><i class="fas fa-times"></i> ยกเลิก</a>
