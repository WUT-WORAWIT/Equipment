...
<html lang="en">
  ...
  <body>
    ...
    <main role="main" class="container">
      ...
      ?>
      <form action="editparinter.process.php?h=<?php echo $dataid1;?>" method="post" enctype="multipart/form-data">
        <input type="hidden" name="id" value="<?php echo $obj['data_sequence']?>"/>
				<br>
			<div class="form-group">
				<label for="exampleInputPassword1">หมายเลขครุภัณฑ์</label>
				<input rows="4" cols="50" name="dataid"  class="form-control" value="<?php echo $obj['data_id2']?>"readonly/>
			</div>
				<div class="form-group">
					<label for="exampleInputPassword1">รายการ</label>
					<textarea rows="4" cols="50" name="datalist" class="form-control" readonly><?php echo $list ?></textarea>
          ...
          <a href="../check.php?id=<?php echo $dataid1;?>" class="btn btn-danger"><i class="fas fa-times"></i> ยกเลิก</a>
