...
$id = $_GET["id"];
$conn = mysqli_connect($server,$username,$password,$dbname);
$sql = "SELECT * FROM tb_dcabinet WHERE data_sequence = '".$id."'";
$query = mysqli_query($conn,$sql);
...
<html lang="en">
  ...
  <body>
    ...
    <main role="main" class="container">
      ...
      ?>
      <form action="edit.dcabinet.process.php" method="post" enctype="multipart/form-data">
        <input type="hidden" name="id" value="<?php echo $obj['data_sequence']?>"/>
				...
				<div class="form-group">
					<label for="exampleInputPassword1">เครืองที่</label>
					<textarea rows="4" cols="50" name="datasequence2" class="form-control" ><?php echo $obj['data_sequence2']?></textarea>
				</div>
				<div class="form-group">
          ...
          <a href="../../admin/data/dataDocument_cabinet.php" class="btn btn-danger"><i class="fas fa-times"></i> ยกเลิก</a>
