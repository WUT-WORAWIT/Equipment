...
$conn = mysqli_connect($server,$username,$password,$dbname)or die('ไม่สามารถติดต่อฐานข้อมูล mysqli ได้'. mysqli_connect_error());
$sql = "SELECT * FROM tb_repair ";
$query = mysqli_query($conn,$sql);
$sumrows = mysqli_num_rows($query);

$conn = mysqli_connect($server,$username,$password,$dbname)or die('ไม่สามารถติดต่อฐานข้อมูล mysqli ได้'. mysqli_connect_error());
$sql = "SELECT * FROM tb_printer ORDER BY data_sequence ASC";
$query = mysqli_query($conn,$sql)or die('ไม่สามารถติดต่อฐานข้อมูล mysqli ได้'. mysqli_connect_error());
  ...
  table-layout:fixed;
   ...
   $(document).ready(function(){
     $('#dataid').blur(function(){
       ...
       $.ajax({
        url:'../check1.php?&category=printer',
        method:"POST",
        data:{data_id:dataid},
...
<!--<body bgcolor ='green'>-->
    <header>
      ...
      <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark"style="background: linear-gradient(40deg,#006400,#00CC00)!important;">
        ...
        <button class="navbar-toggler" type="buttvon" data-toggle="collapse" data-target="#navbarCollapse" aria-controls="navbarCollapse" aria-expanded="false" aria-label="Toggle navigation">
  ...
  <main role="main" class="container" width="10px">
		<div class="container">
			<?php
									...
									$p = '%'.$pro_search.'%';
									$sql_s = "SELECT * FROM tb_printer WHERE data_id LIKE '$p'OR data_list LIKE '$p'" ;
									...
									<div class="col-12 col-md-10 col-lg-8">
											<form class="form-group"action="dataPrinter.php"method="post"style="width:390px;margin-top :-20px;">
													<div class="card-body row no-gutters align-items-center">
															...
															<!--end of col-->
															<div class="col-auto">
																	<button style=" font-size: 16px;"class="btn btn-lg btn-success"name="dds" id="dds"onClick="this.form.action='dataPrinter.php'" type="submit">ค้นหา</button>
															</div>
															<!--end of col-->
													</div>
											</form>
		...
		<form method="post" action="../test.php?&category=printer">
  ...
  <tbody>
    ...
    <tr>
			<td rows="5" align="center" >
				<a href="../editData/edit.printer.php?id=<?php echo $obj['data_sequence']?>" class="btn btn-warning btn-sm" ><i class="far fa-edit"></i></a><br>
				<a style="margin-top:2px;"href="../delete/delete.dataPrinter.php?id=<?php echo $obj['data_sequence']?>" class="btn btn-danger btn-sm" onClick="javascript:return confirm('คุณต้องการลบ <?php echo $obj['data_name']?> ใช่หรือไม่');"><i class="far fa-trash-alt"></i></a>
				<?php if($obj['data_pic']==""): ?>
				<a href="../qrcode/ger_qr_printer.php?id=<?php echo $obj['data_sequence']?>&category=printer"   class="fas fa-qrcode f029" style="font-size:34px;color:black "></a>
				<?php endif; ?></td>
				<td align="center">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="../insertData/insert.printer.php" method="post" enctype="multipart/form-data">
