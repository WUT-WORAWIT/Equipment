...
$conn = mysqli_connect($server,$username,$password,$dbname);
$sql = "SELECT * FROM tb_sliding ORDER BY data_sequence ASC";
$query = mysqli_query($conn,$sql);
  ...
  <body>
   ...
   $(document).ready(function(){
     $('#dataid').blur(function(){
       ...
       $.ajax({
        url:'../check1.php?&category=sliding',
        method:"POST",
        data:{data_id:dataid},
...
<body>
  ...
  <main role="main" class="container" width="10px">
		<div class="container">
			<?php
									...
									$p = '%'.$pro_search.'%';
									$sql_s = "SELECT * FROM tb_sliding WHERE data_id LIKE '$p'OR data_list LIKE '$p'" ;
									...
									<div class="col-12 col-md-10 col-lg-8">
											<form class="form-group"action="dataPrinter.php"method="post"style="width:390px;margin-top :-20px;">
													<div class="card-body row no-gutters align-items-center">
															...
															<!--end of col-->
															<div class="col-auto">
																	<button style=" font-size: 16px;"class="btn btn-lg btn-success"name="dds" id="dds"onClick="this.form.action='dataSliding.php'" type="submit">ค้นหา</button>
															</div>
															<!--end of col-->
													</div>
											</form>
		...
		<form method="post" action="../test.php?&category=sliding">
  ...
  <tbody>
    ...
    <tr>
			<td align="center">
				<a href="../editData/edit.sliding.php?id=<?php echo $obj['data_sequence']?>" class="btn btn-warning btn-sm" ><i class="far fa-edit"></i></a><br>
				<a style="margin-top:2px;" href="../delete/delete.dataSliding.php?id=<?php echo $obj['data_sequence']?>" class="btn btn-danger btn-sm" onClick="javascript:return confirm('คุณต้องการลบ <?php echo $obj['data_name']?> ใช่หรือไม่');"><i class="far fa-trash-alt"></i></a>
				<?php if($obj['data_pic']==""): ?>
					<a href="../qrcode/ger_qr_printer.php?id=<?php echo $obj['data_sequence']?>&category=sliding"   class="fas fa-qrcode f029" style="font-size:34px;color:black "></a>
				<?php endif; ?></td>
				<td align="center">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="../insertData/insert.Sliding.php" method="post" enctype="multipart/form-data">
