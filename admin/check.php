        ...
        td{
          ...
          <main role="main" class="container" width="10px">
            <div class="container">
        			<?php
                        if($pro_search = $_POST['pro_search']):
                        $p = '%'.$pro_search.'%';
                        $p= "SELECT * FROM tb_list INNER JOIN tb_data ON (tb_list.data_id=tb_data.data_id1) WHERE data_id2 LIKE '$p'" ;
                        $query = mysqli_query($conn,$p);
                      endif;
        				?>
        		<div class="row justify-content-center">
        									<div class="col-12 col-md-10 col-lg-8">
        											<form class="form-group"action="check.php?id=<?php echo $id?>"method="post"style="width:390px;margin-top :-20px;">
        													<div class="card-body row no-gutters align-items-center">
        															...
        															<!--end of col-->
        															<div class="col-auto">
        																	<button style=" font-size: 16px;"class="btn btn-lg btn-success"type="submit">ค้นหา</button>
        															</div>
        															<!--end of col-->
        													</div>
        											</form>
        		...
        		<form method="post" action="print.php?&category=printer">
        ...
        <br><table class="table table-sm table-bordered table-hover "style="width:90%;" border="12" >
          ...
          <tbody>
            ...
            <tr>
        			<td rows="5" align="center" >
        				<a href="editData/edit.printer.php?id=<?php echo $obj['data_sequence']?>&list=<?php echo $obj['data_list']?>&category=<?php echo $id?>" class="btn btn-warning btn-sm" ><i class="far fa-edit"></i></a><br>
        				<a style="margin-top:2px;"href="delete/delete.dataPrinter.php?id=<?php echo $obj['data_sequence']?>&h=<?php echo $id?>" class="btn btn-danger btn-sm" onClick="javascript:return confirm('คุณต้องการลบ <?php echo $obj['data_name']?> ใช่หรือไม่');"><i class="far fa-trash-alt"></i></a>
        				<?php if($obj['data_pic']==""): ?>
        				<a href="qrcode/ger_qr_data.php?id=<?php echo $obj['data_sequence']?>&category=<?php echo $id?>"   class="fas fa-qrcode f029" style="font-size:34px;color:black "></a>
        				<?php endif; ?></td>
        				<td align="center">
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form action="insertData/insert.printer.php?h=<?php echo $id?>&list=<?php echo $list ?>" method="post" enctype="multipart/form-data">
          ...
          <input type="hidden" name="h=<?php echo $id?>">
                  </div>
